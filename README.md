# Merkle Innovation - Assessment Test
 This project was created as part of the assessment test for Merkle Innovation's Frontend Engineer role. The application was built using the Next.js framework and other modern tools.
